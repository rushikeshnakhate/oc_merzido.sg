<?php
// HTTP
define('HTTP_SERVER', 'http://13.250.104.69/merzido.sg/upload/admin/');
define('HTTP_CATALOG', 'http://13.250.104.69/merzido.sg/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://13.250.104.69/merzido.sg/upload/admin/');
define('HTTPS_CATALOG', 'http://13.250.104.69/merzido.sg/upload/');

// DIR
define('DIR_APPLICATION', '/var/www/html/merzido.sg/upload/admin/');
